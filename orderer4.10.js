...
var orderer4 = '{"id":"orderer2","state":"follower","term":1} '; //JSON형식으로 데이터 저장 
...
&& orderer_parse.rejoin !='yes'&&orderer_parse.state != 'dead' &&orderer_parse.state !='rejoin'){
  ...
  console.log('change follwer',orderer_parse);
   ...
   if(i.candidate == 'orderer4'&& orderer_parse.state!='leader'&& orderer_parse.rejoin !='yes'&&orderer_parse.state !='rejoin'){
