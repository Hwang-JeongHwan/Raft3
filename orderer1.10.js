...
if((i.candidate =='orderer5'||i.candidate =='orderer2'||i.candidate =='orderer5'||i.candidate =='orderer4')
&& orderer_parse.rejoin !='yes'&&orderer_parse.state != 'dead' &&orderer_parse.state !='rejoin'){
  orderer_parse.state =  'follower';
  console.log('change follwer',orderer_parse);
}
   if(i.candidate == 'orderer1'&& orderer_parse.state!='leader'&& orderer_parse.rejoin !='yes' &&orderer_parse.state !='rejoin'){
