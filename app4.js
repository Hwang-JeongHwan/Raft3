...
var json = '{"id":"app","key":"x","value":1,"cnt":0,"start":0,"x1":100,"x2":100,"x3":100,"x4":100,"x5":100,"x6":100,"x7":100,"x8":100,"x9":100,"x10":100}'//JSON형식으로 선언
...
*/              app.try +=1;
          ...
          //console.log(i);
            ...
            if (i.commit == 'commit'){ //4번 
                
                a = 0
                b = 0
                
                while (true){
                    a = Random.getRandomInt(1, 10)
                    b = Random.getRandomInt(1, 10)
                    if (a != b){
                        console.log("a:", a, "b:",b)
                        break
                    }
